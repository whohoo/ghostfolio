...
@Injectable()
export class CnFundService implements DataProviderInterface {
  private readonly logger = new Logger(CnFundService.name);
  ...
  public constructor(
    ...
    this.proxyUrl = this.configurationService.get('CN_FUND_PROXY_URL');
  }
